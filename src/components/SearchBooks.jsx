...
export function SearchBooks() {
  ...
  const { handleLogout, user, addReservedBooks, isBookReserved, reservedBooks } = useContext(ContextLibrary);
  const [alert, setAlert] = useState(false);

  // Buscar por medio del BUSCADOR (input )
  ...
  if (!user) {
    return (
      <div className="div-loading">
        <img className="img-loading" src="../../svg/logo.png" />
        <h1 className="h1-loading"> Cargando datos.</h1>
        <p className="p-loading">
          This may take a few minutes, please be patiente.
        </p>
      </div>
    );
  }
  ...
  return (
    <>
          ...
          {handleUserCard && (
            <div className="menu">
              <div className="menu-item">
                ...
                <button className="perfil-mybooks">
                  <FaBookBookmark className="menu-book-btn" />
                  My books
                </button>
                <button className="history-btn">
                  <BsFillSave2Fill className="menu-history-btn" />
                  My history
                </button>
      ...
      <div className="main-container">
        <aside className="aside-container">
          ...
          <div className="div-container1">
            ...
            <button onClick={navigateMyBooks} className="btn-aside">
              My Books
            </button>
                  ...
                  >
                    ...
                    <div className="data-popover">
                      ...
                      <div className="labels-popover">
                        ...
                        <div className="data">
                          <button
                            onClick={() => handleBookReserve(e)}
                            className="reserve-popover"
                            disabled={reservedBooks.some((book) => book.id == e.id)}
                          >
                            Reserve
                          </button>
                        </div>
      ...
      {alert && (
        <div className={`div-alert ${alert ? "active" : ""}`}>
          <FaCheck className="check-alert" />
          <h1 className="h1-alert"> Your book has been reserved!</h1>
          <button onClick={() => setAlert(false)} className="btn-alert" disabled={isBookReserved}>
            <IoClose className="close-alert" />
          </button>
        </div>
      )}
